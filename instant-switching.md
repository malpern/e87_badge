...
[`e87_badge.gallery`](https://github.com/malpern/e87_badge/blob/feat/instant-asset-switching/src/e87_badge/gallery.py):
...
is documented in [Protocol reference](protocol) and the investigation writeup that
